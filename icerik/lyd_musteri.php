...
<?
    ...
    $musterii = row(query("SELECT * FROM sirketler WHERE musteri_id = '$musteri' AND sirket_tip = 'musteri'"));
        ...
        <div class="content-wrapper">
            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    <h6 class="panel-title"><?= $d["musteri"] ?></h6>
                </div>
                ...
                <div class="panel-body">
                        ...
                        <form id="musteribilgileri" class="form-horizontal" enctype="multipart/form-data" method="post" action="" onchange="kontrol()">
                            ...
                            <div class="col-md-4">
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <legend class="text-bold"><?= $d["musteribilgileri"] ?></legend>

                                    <input type="hidden" name="musteriid" id="musteriid" value="<?= $musteri ?>">

                                    <div class="form-group">
                                        <label class="control-label col-lg-2"><?= $d["musteriadi"] ?></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="musteriAdi" placeholder="<?= $d["musteriadi"] ?>" value="<?= $musterii["musteri_adi"] ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2"><?= $d["musterikodu"] ?></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="musteriKodu" placeholder="<?= $d["musterikodu"] ?>" value="<?= $musterii["musteri_kodu"] ?>">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-lg-2"><?= $d["musteribilgi"] ?></label>
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="musteriBilgi" rows="2" placeholder="<?= $d["musteribilgi"] ?>"><?= $musterii["musteri_bilgi"] ?></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <fieldset class="content-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2"><?= $d["kullandigimarka"] ?></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="musteriEkKullandigiMarka" placeholder="<?= $d["kullandigimarka"] ?>" value="<?= $musterii["musteri_ek_kullandigi_marka"] ?>">
                                        </div>
                                    </div>
                    ...
                    <script>
                        ...
                        function musteriekle() {
                            ...
                            $.ajax({
                                url:'fonksiyon/musteriekle.php', // serileştirilen değerleri ajax.php dosyasına
                        ...
                        function musteriguncelle() {
                            ...
                            $.ajax({
                                url:'fonksiyon/musteriguncelle.php', // serileştirilen değerleri ajax.php dosyasına
                                type:'POST', // post metodu ile
                                data:musteribilgileri, // yukarıda serileştirdiğimiz gonderilenform değişkeni
                                success:function(e){ // gonderme işlemi başarılı ise e değişkeni ile gelen değerleri aldı
                                    if(e !== "hata" && e !== "eksik"){
