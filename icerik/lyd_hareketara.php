            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-category">
                    ...
                    <div class="category-content">
                        <input onkeyup="ara()" class="form-control" type="text" id="hareketkodu" name="hareketkodu" placeholder="<?= $d["hareketkodu"] ?>" value="<?= g("ar") ?>">
                    </div>
                </div>
                <!-- /actions -->
                ...
                <script>
                    ...
                    function ara() {
                        ...
                        var term = document.getElementById("hareketkodu").value;

                        $.ajax({
                            url:'fonksiyon/hareketara.php', // serileştirilen değerleri ajax.php dosyasına
