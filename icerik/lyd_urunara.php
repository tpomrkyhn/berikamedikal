            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-category">
                    ...
                    <div class="category-content">
                        <input onkeyup="ara()" class="form-control" type="text" id="urunadikodu" name="urunadikodu" placeholder="<?= $d["urunadikodu"] ?>" value="<?= g("ar") ?>">
                    </div>
                </div>
                <!-- /actions -->
                ...
                <script>
                    ...
                    function ara() {
                        ...
                        var term = document.getElementById("urunadikodu").value;

                        $.ajax({
                            url:'fonksiyon/urunara.php', // serileştirilen değerleri ajax.php dosyasına
