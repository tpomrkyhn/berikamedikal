            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-category">
                    ...
                    <div class="category-content">
                        <input onkeyup="ara()" class="form-control" type="text" id="grupadikodu" name="grupadikodu" placeholder="<?= $d["grupadikodu"] ?>" value="<?= g("ar") ?>">
                    </div>
                </div>
                <!-- /actions -->
                ...
                <script>
                    ...
                    function ara() {
                        ...
                        var term = document.getElementById("grupadikodu").value;

                        $.ajax({
                            url:'fonksiyon/parcagrupara.php', // serileştirilen değerleri ajax.php dosyasına
